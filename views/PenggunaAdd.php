...
loadjs.ready("head", function () {
    ...
    fpenggunaadd = currentForm = new ew.Form("fpenggunaadd", "add");
    ...
    // Validate form
    fpenggunaadd.validate = function () {
    ...
    fpenggunaadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpenggunaadd.lists.role = <?= $Page->role->toClientList($Page) ?>;
