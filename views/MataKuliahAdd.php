...
loadjs.ready("head", function () {
    ...
    fmata_kuliahadd = currentForm = new ew.Form("fmata_kuliahadd", "add");
    ...
    // Validate form
    fmata_kuliahadd.validate = function () {
    ...
    // Form_CustomValidate
    fmata_kuliahadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmata_kuliahadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fmata_kuliahadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fmata_kuliahadd" id="fmata_kuliahadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
