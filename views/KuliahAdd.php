...
loadjs.ready("head", function () {
    ...
    fkuliahadd = currentForm = new ew.Form("fkuliahadd", "add");
    ...
    // Form_CustomValidate
    fkuliahadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fkuliahadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fkuliahadd.lists.id_mk = <?= $Page->id_mk->toClientList($Page) ?>;
    fkuliahadd.lists.id_mhs = <?= $Page->id_mhs->toClientList($Page) ?>;
    loadjs.done("fkuliahadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fkuliahadd" id="fkuliahadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fkuliahadd"], function() {
    fkuliahadd.createAutoSuggest(Object.assign({"id":"x_id_mk","forceSelect":false}, ew.vars.tables.kuliah.fields.id_mk.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fkuliahadd"], function() {
    fkuliahadd.createAutoSuggest(Object.assign({"id":"x_id_mhs","forceSelect":false}, ew.vars.tables.kuliah.fields.id_mhs.autoSuggestOptions));
});
</script>
