...
return [
    ...
    // Tables
    "mahasiswa" => \DI\create(Mahasiswa::class),
    "mata_kuliah" => \DI\create(MataKuliah::class),
    "pengguna" => \DI\create(Pengguna::class),
    "kuliah" => \DI\create(Kuliah::class),
    "v_mhs" => \DI\create(VMhs::class),
    "v_mk" => \DI\create(VMk::class),
    "v_kuliah" => \DI\create(VKuliah::class),
