 ...
 * Page class
 */
class KuliahDelete extends Kuliah
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KuliahDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("kuliahlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("kuliahlist"); // Return to list
                return;
            }
        }
