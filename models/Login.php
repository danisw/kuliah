...
class Login extends Pengguna
{
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("pengguna", "pengguna", "username", "username", "username", "", 202, 255, 0, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-control");
        $this->Password = new DbField("pengguna", "pengguna", "password", "password", "password", "", 202, 255, 0, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("pengguna", "pengguna", "type", "logintype", "logintype", "", 202, 255, 0, false, "", false, false, false);
