...
class PenggunaList extends Pengguna
{
    ...
    public function __construct()
    {
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fpenggunalistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("pengguna"));
                $doc->Text = @$content;
    ...
    protected function hideFieldsForAddEdit()
    {
        if ($this->isAdd() || $this->isCopy() || $this->isGridAdd()) {
            $this->id_pengguna->Visible = false;
        }
    }
    ...
    public function run()
    {
        ...
        $this->id_pengguna->setVisibility();
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->id_pengguna->AdvancedSearch->toJson(), ","); // Field id_pengguna
        $filterList = Concat($filterList, $this->nomor_induk->AdvancedSearch->toJson(), ","); // Field nomor_induk
        $filterList = Concat($filterList, $this->nama_pengguna->AdvancedSearch->toJson(), ","); // Field nama_pengguna
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpenggunalistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field id_pengguna
        $this->id_pengguna->AdvancedSearch->SearchValue = @$filter["x_id_pengguna"];
        $this->id_pengguna->AdvancedSearch->SearchOperator = @$filter["z_id_pengguna"];
        $this->id_pengguna->AdvancedSearch->SearchCondition = @$filter["v_id_pengguna"];
        $this->id_pengguna->AdvancedSearch->SearchValue2 = @$filter["y_id_pengguna"];
        $this->id_pengguna->AdvancedSearch->SearchOperator2 = @$filter["w_id_pengguna"];
        $this->id_pengguna->AdvancedSearch->save();
        ...
        // Field nama_pengguna
        $this->nama_pengguna->AdvancedSearch->SearchValue = @$filter["x_nama_pengguna"];
        $this->nama_pengguna->AdvancedSearch->SearchOperator = @$filter["z_nama_pengguna"];
        $this->nama_pengguna->AdvancedSearch->SearchCondition = @$filter["v_nama_pengguna"];
        $this->nama_pengguna->AdvancedSearch->SearchValue2 = @$filter["y_nama_pengguna"];
        $this->nama_pengguna->AdvancedSearch->SearchOperator2 = @$filter["w_nama_pengguna"];
        $this->nama_pengguna->AdvancedSearch->save();
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->nomor_induk, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->nama_pengguna, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->id_pengguna); // id_pengguna
            $this->updateSort($this->nomor_induk); // nomor_induk
            $this->updateSort($this->nama_pengguna); // nama_pengguna
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->id_pengguna->setSort("");
                $this->nomor_induk->setSort("");
                $this->nama_pengguna->setSort("");
                $this->role->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->id_pengguna->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpenggunalistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpenggunalistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fpenggunalist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    public function loadRowValues($rs = null)
    {
        ...
        $this->id_pengguna->setDbValue($row['id_pengguna']);
        $this->nomor_induk->setDbValue($row['nomor_induk']);
        $this->nama_pengguna->setDbValue($row['nama_pengguna']);
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            // id_pengguna
            $this->id_pengguna->ViewValue = $this->id_pengguna->CurrentValue;
            $this->id_pengguna->ViewCustomAttributes = "";
            ...
            // id_pengguna
            $this->id_pengguna->LinkCustomAttributes = "";
            $this->id_pengguna->HrefValue = "";
            $this->id_pengguna->TooltipValue = "";
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpenggunalistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
