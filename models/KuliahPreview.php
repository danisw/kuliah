 ...
 * Page class
 */
class KuliahPreview extends Kuliah
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KuliahPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "v_mhs") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=v_mhs&" . GetForeignKeyUrl("fk_id_mhs", $this->id_mhs->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "v_mhs") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->id_mhs->setQueryStringValue($val);
            }
        }
    }
