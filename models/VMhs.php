...
/**
 * Table class for v_mhs
 */
class VMhs extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id_mhs
        $this->id_mhs = new DbField('v_mhs', 'v_mhs', 'x_id_mhs', 'id_mhs', '`id_mhs`', '`id_mhs`', 3, 11, -1, false, '`id_mhs`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // nim
        $this->nim = new DbField('v_mhs', 'v_mhs', 'x_nim', 'nim', '`nim`', '`nim`', 200, 255, -1, false, '`nim`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama_mhs
        $this->nama_mhs = new DbField('v_mhs', 'v_mhs', 'x_nama_mhs', 'nama_mhs', '`nama_mhs`', '`nama_mhs`', 200, 255, -1, false, '`nama_mhs`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jurusan
        $this->jurusan = new DbField('v_mhs', 'v_mhs', 'x_jurusan', 'jurusan', '`jurusan`', '`jurusan`', 200, 255, -1, false, '`jurusan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "kuliah") {
            $detailUrl = Container("kuliah")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id_mhs", $this->id_mhs->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "vmhslist";
        }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("mahasiswa.*");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("vmhslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "vmhsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "vmhsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "vmhsadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("vmhsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("vmhsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "vmhsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "vmhsadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("vmhsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("vmhsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("vmhsdelete", $this->getUrlParm());
    }
